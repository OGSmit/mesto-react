...
return (
  <div className="page">
    <CurrentUserContext.Provider value={currentUser} >
      ...
      <EditProfilePopup onKeyPress={closeEsc} isApiProcessing={isApiProcessing} onUpdateUser={handleUpdateUser} isOpened={isEditProfilePopupOpen} onClose={closeAllPopups} />
